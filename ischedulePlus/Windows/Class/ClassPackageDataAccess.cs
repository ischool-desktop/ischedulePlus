...
namespace ischedulePlus
{
    ...
    public class ClassPackageDataAccess : IConfigurationDataAccess<ClassPackage>
    {
        ...
        {
            string strSQL = "select class_name from $scheduler.class_ex order by class_code,grade_year,class_name";
        ...
        public string Update(string Key, string NewKey)
        {
            ...
            if (Classes.Count == 1)
            {
                ...
                Classes.SaveAll();
                CalendarEvents.RaiseClassUpdateEvent();
        ...
        public string Insert(string NewKey, string CopyKey)
        {
            ...
            if (CopyClass != null)
            {
                ...
                NewClass.ClassCode = CopyClass.ClassCode;
            }
            ...
            return "已成功新增" + NewClassIDs.Count + "筆班級";
        }
        ...
        /// <param name="CopyKey">要複製的班級名稱</param>
        /// <returns>傳回新增成功或失敗訊息</returns>
        public string Insert_new(string NewKey, string CopyKey, string ClassCode)
        {
            #region 根據鍵值取得班級
            if (string.IsNullOrEmpty(NewKey))
                return "要新增的班級名稱不能為空白!";
        ...
        public string Delete(string Key)
        {
            ...
            else
            {
                ...
                return "已刪除班級「" + vClass.ClassName + "」筆班級記錄!";
            }
        }
