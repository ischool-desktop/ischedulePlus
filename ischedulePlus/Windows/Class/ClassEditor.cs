...
namespace ischedulePlus
{
    ...
    public partial class ClassEditor : UserControl, IContentEditor<ClassPackage>
    {
        ...
        private void ReiEver()
        {
            ...
            txtClassCode.TextChanged += (sender, e) =>
            {
                IsDirty = true;
            };
        }
        ...
        public ClassPackage Content
        {
            get
            {
                ...
                mClassPackage.Class.ClassCode = txtClassCode.Text;
                mClassPackage.Class.Note = txtNote.Text;
                #endregion
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    if (mClassPackage.Class != null)
                    {
                        ...
                        txtClassCode.Text = mClassPackage.Class.ClassCode;
                        txtNote.Text = mClassPackage.Class.Note;
                    }
