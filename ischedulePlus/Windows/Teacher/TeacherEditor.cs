...
namespace ischedulePlus
{
    ...
    public partial class TeacherEditor : UserControl, IContentEditor<TeacherPackage>
    {
        ...
        private void ReiEver()
        {
            ...
            textBoxX3.TextChanged += (sender, e) =>
            {
                IsDirty = true;
            };
        }
        ...
        public void Prepare()
        {
            decCalendar = new DecCalendar(panelEx2);
        ...
        public TeacherPackage Content
        {
            get
            {
                ...
                //2013/7/24 dylan
                mTeacherPackage.Teacher.TeacherCode = textBoxX1.Text;
                mTeacherPackage.Teacher.TeachingExpertise = textBoxX2.Text;
                mTeacherPackage.Teacher.Note = textBoxX3.Text;

                #region 從UI上取得場地忙碌時段(註解)
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    {
                        textBoxX1.Text = mTeacherPackage.Teacher.TeacherCode;
                        textBoxX2.Text = mTeacherPackage.Teacher.TeachingExpertise;
                        textBoxX3.Text = mTeacherPackage.Teacher.Note;
                    }
                    ...
                    if (mTeacherPackage.Teacher != null)
                    {
                        ...
                        string TeacherName = mEditorName;

                        //List<CalendarRecord> vCalendarRecords = Utility.GetTeacherCalendars(TeacherName, SchoolYearSemesterOption.Instance.StartDate, SchoolYearSemesterOption.Instance.EndDate);

                        decCalendar.Type = CalendarType.Teacher;
                        decCalendar.AssocID = TeacherName;
                        //decCalendar.DataSource = vCalendarRecords;
