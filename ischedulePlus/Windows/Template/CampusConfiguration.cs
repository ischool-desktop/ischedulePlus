...
namespace ischedulePlus
{
    ...
    public partial class CampusConfiguration<T> : ConfigurationItem
    {
        ...
        public CampusConfiguration(IConfigurationDataAccess<T> vDataAccess, IContentEditor<T> vEditor)
        {
            ...
            if (!K12.Data.Utility.Utility.IsNullOrEmpty(mDataAccess.ExtraCommands))
            {
        ...
        private void Search()
        {
            ...
            grdNameList_SelectionChanged(this, new EventArgs());
        }
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            else if (mDataAccess.DisplayName.Equals("學期設定"))
            {
                SchoolYearSemesterCreatorForm vCreatorForm = new SchoolYearSemesterCreatorForm(mDataAccess as SchoolYearSemesterPackageDataAccess);
